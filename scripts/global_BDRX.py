...
downloadPath = os.path.abspath('./../database/global_BDRX')
...
url = "https://www.b3.com.br/pt_br/market-data-e-indices/indices/indices-de-segmentos-e-setoriais/indice-de-bdrs-nao-patrocinados-global-bdrx-estatisticas-historicas.htm"
...
driver.quit()
if(os.path.exists(os.path.join(downloadPath, "global_BDRX.csv"))):
    os.remove(os.path.join(downloadPath, "global_BDRX.csv"))
...
for file in os.listdir(downloadPath):
    if file.endswith(".csv"):
        ...
        finalDf.to_csv(os.path.join(downloadPath, "global_BDRX.csv"),  sep = ",", index=False)
