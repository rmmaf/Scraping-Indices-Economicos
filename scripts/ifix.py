...
downloadPath = os.path.abspath('./../database/IFIX')
...
driver.quit()
if(os.path.exists(os.path.join(downloadPath, "IFIX.csv"))):
    os.remove(os.path.join(downloadPath, "IFIX.csv"))
...
for file in os.listdir(downloadPath):
    if file.endswith(".csv"):
        ...
        finalDf.to_csv(os.path.join(downloadPath, "IFIX.csv"),  sep = ",", index=False)
