...
ipcaGeral = driver.find_element(By.LINK_TEXT, "IPCA - taxa de variação")
...
finalDf.to_csv(os.path.join(downloadPath, "ipcaAnual.csv"),  sep = ",", index=False)