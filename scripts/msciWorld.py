...
downloadPath = os.path.abspath('./../database/msciWorld')
...
url = "https://br.investing.com/indices/msci-world-historical-data"
...
finalDf.to_csv(os.path.join(downloadPath, "msciWorld.csv"),  sep = ",", index=False)