...
writePath = os.path.abspath('./../database/SMALL')
os.makedirs(writePath, mode=0o777, exist_ok=True)  # create dir if it not exist

url = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&datatype=csv&symbol=SMLL.SA&apikey=9271MV28TR4HK23C'
...
finalDf.to_csv(os.path.join(writePath, "SMALL.csv"),  sep = ",", index=False)